...
- Approximately 18 monthly datasets
- Each ZIP file contains CSV trip records
- Jersey City trips for the year 2025 and 2026 are extracted and combined
...
![](img/ride_per_season.png){width=80%}

---

![](img/rides_per_month.png){width=80%}

---

![](img/rides_per_day_of_week.png){width=80%}

---

![](img/rides_per_time_of_day.png){width=80%}
...
![Top 10 Routes](img/top_10_routes.png){width=90%} 
...
![](img/rides_vs_temperature.png){width=80%}

---

![](img/rides_vs_temp_and_wind_speed.png){width=80%}

---

![](img/rides_vs_tempr_precip.png){width=80%}
...
[Tableau Dashboard](https://public.tableau.com/app/profile/marine.petrosyan/viz/citibike_with_db/CitiBikeJerseyCityDashboard?publish=yes){target="_blank"}
...
### Likedin: 
#### https://www.linkedin.com/in/marine-petrosyan-144826141/ 
\

### GitHub
#### https://github.com/MarTvyal62
\

### Tableau Public
#### https://public.tableau.com/app/profile/marine.petrosyan/viz/citibike_with_db/CitiBikeJerseyCityDashboard?publish=yes)
